...
public class ZookeeperServiceWrong implements Watcher {
	...
	public static ZookeeperServiceWrong getInstance() throws IOException, InterruptedException {
	...
	public void connect(final String host) throws IOException, InterruptedException {
	 ...
	 */
	public synchronized List<String> createNewMesa(final String mesa) throws KeeperException, InterruptedException {

		// TODO: Verificar que o Watch foi colocado e como usá-lo.

		String mesaId = this.getZooKeeper().create("/" + mesa, null, Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
	...
	public String createNewPlayerNode(final Player player, final int key) throws KeeperException, InterruptedException {
		...
		return this.getZooKeeper().create("/" + player.getMesa() + "/" + player.getName(), String.valueOf(key).getBytes(),
	...
	public String createZNode(final Player player, final byte[] data) throws KeeperException, InterruptedException {
		return this.getZooKeeper().create("/" + player.getMesa() + "/" + player.getName(), data, Ids.OPEN_ACL_UNSAFE,
	...
	public synchronized void awaitPlayerRegistration() throws InterruptedException {
